...
class LoginForm extends DbConn
{
    public function checkLogin($myusername, $mypassword)
    {
        ...
        if ($curr_attempts >= $max_attempts && $timeDiff < $login_timeout) {
            ...
            $success = "<div class=\"ui icon error visible message\">
                  ...
                  <div class=\"content\">
                    ...
                    <p>please wait ".$timeout_minutes." minutes before logging in again</p>
                </div>
            </div>";
            ...
            if (password_verify($mypassword, $result['password']) && $result['verified'] == '1') {
                ...
                $success = "
                <div class=\"ui icon warning visible message\">
                  ...
                  <div class=\"content\">
                    ...
                    <p>but you cannot log in until it has been verified</p>
                </div>
            </div>";
