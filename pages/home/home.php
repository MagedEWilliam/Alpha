...
<div class="sixteen wide column " class="toppon" style="width: 100%;">
	<div class="row">
	...
	<div class="sixteen wide column" style="background-color: white !important">
		...
		<center style="margin-left: auto;margin-right: auto;">
			...
			<br>
			<br>
			<a class="ui primary basic button" href="products?lang=<?php echo $_GET['lang'];?>">BROWSE ALL PRODUCTS</a>
		</center>
